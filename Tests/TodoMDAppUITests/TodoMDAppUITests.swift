...
final class TodoMDAppUITests: XCTestCase {
    ...
    func testOnboardingDefaultFolderThenQuickAddCreatesTaskAndAppStaysResponsive() {
        ...
        let titleField = app.textFields["quickEntry.titleField"]
        ...
        XCTAssertFalse(titleField.waitForExistence(timeout: 2), "Quick Entry sheet did not dismiss")
        ...
        quickAddButton.tap()
        XCTAssertTrue(titleField.waitForExistence(timeout: 5), "App became unresponsive after adding task")
