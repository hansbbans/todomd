...
struct AreasTabDescriptor: Equatable {
    let listID: String
    let taskRecordPaths: [String]
    let showsInlineComposer: Bool
    let emptyState: AreasTabEmptyState?
...
struct AreasTabEmptyState: Equatable {
    let title: String
    let symbol: String
    let subtitle: String
...
struct AreasTabView<HeroRow: View, InlineComposer: View, TaskRow: View, SummaryRow: View>: View {
    let descriptor: AreasTabDescriptor
